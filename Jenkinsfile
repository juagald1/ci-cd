pipeline {
    ...
    environment {
        GitDirPC = 'C:\\Users\\Juan\\Documents\\GitHub\\ci-cd'			//Completar por usuario ubicación del repositorio
		DirWorkspace ='C:\\Users\\Juan\\workspace'						//Completar por usuario ubicación del workspace		
